...
if (isset($set['next'])) {
    echo '<script>';
    echo 'window.NEXT_WIDGET_TO_TOP = ' . ($set['next']['NEXT_WIDGET_TO_TOP'] ? 'true' : 'false') . ';';
    echo 'window.NEXT_WIDGET_TO_BOTTOM = ' . ($set['next']['NEXT_WIDGET_TO_BOTTOM'] ? 'true' : 'false') . ';';
    echo 'window.NEXT_WIDGET_TOC = ' . ($set['next']['NEXT_WIDGET_TOC'] ? 'true' : 'false') . ';';
    echo '</script>';
}
...
<div class="go-top-plane" title="返回顶部" <?php if (!$set['next']['NEXT_WIDGET_TO_TOP']) echo 'style="display:none"'; ?>>
    <i class="fa fa-arrow-up" aria-hidden="true"></i>
</div>

<?php if (isset($set['next']['NEXT_WIDGET_TO_BOTTOM']) && $set['next']['NEXT_WIDGET_TO_BOTTOM']): ?>
<div class="go-bottom-plane" title="返回底部">
